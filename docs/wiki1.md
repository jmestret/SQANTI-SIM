## What is SQANTISIM? <img src="https://github.com/jorgemt98/SQANTI-SIM/blob/main/docs/red_small_logo.png" align="right" alt="" width="50" />
...
Information about running the classification step can be found at [*SQANTISIM: classif*](https://github.com/jorgemt98/SQANTI-SIM/blob/main/docs/wiki5.md).
...
Information about running the design step can be found at [*SQANTISIM: design*](https://github.com/jorgemt98/SQANTI-SIM/blob/main/docs/wiki6.md).
...
Information about running the simulation step can be found at [*SQANTISIM: sim*](https://github.com/jorgemt98/SQANTI-SIM/blob/main/docs/wiki7.md).
...
Information about running the evaluation step can be found at [*SQANTISIM: eval*](https://github.com/jorgemt98/SQANTI-SIM/blob/main/docs/wiki8.md).
