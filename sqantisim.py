...
def design(input: list):
    ...
    parser_e.add_argument("-i", "--trans_index", type=str, required=True, help="\t\tFile with transcript information generated by SQANTISIM (*_index.tsv)", )
    ...
    parser_c.add_argument("-i", "--trans_index", type=str, required=True, help="\t\tFile with transcript information generated with SQANTISIM (*_index.tsv)", )
    ...
    parser_s.add_argument("-i", "--trans_index", type=str, required=True, help="\t\tFile with transcript information generated with SQANTISIM (*_index.tsv)", )
...
def sim(input: list):
    ...
    parser.add_argument("-i", "--trans_index", type=str, required=True, help="\t\tFile with transcript information generated with SQANTISIM (*_index.tsv)", )
...
def eval(input: list):
    ...
    parser.add_argument("--fasta", action="store_true", help="\t\tUse when running SQANTISIM by using as input a FASTA/FASTQ with the sequences of isoforms", )
    ...
    print("\n[SQANTISIM] Running with the following parameters:")
    print("[SQANTISIM] - Reconstructed transcripts:", str(args.transcriptome))
