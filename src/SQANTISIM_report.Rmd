...
```{r}
grid.arrange(p5.min.1, p5.min.2, ncol = 2, nrow = 1)
```

#### Transcript length

```{r}
grid.arrange(p6.min.1, p6.min.2, ncol = 2, nrow = 1)
```

#### Expression level

```{r}
grid.arrange(p7.min.1, p7.min.2, ncol = 2, nrow = 1)
```

#### Isoform complexity

```{r}
grid.arrange(p8.min.1, p8.min.2, ncol = 2, nrow = 1)
```
