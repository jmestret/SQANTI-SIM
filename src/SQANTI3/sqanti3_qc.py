...
# NOTE: this file was modified to fit the SQANTI-SIM pipeline based on the
# sqanti3_lrgasp_challenge1.py script
...
FIELDS_CLASS = ['isoform', 'chrom', 'strand', 'length',  'exons',  'structural_category',
                ...
                'TSS_genomic_coord', 'TTS_genomic_coord']
...
class myQueryTranscripts:
    ...
    def __str__(self):
        return "%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s" % (self.chrom, self.strand,
                                                                                                                                                           ...
                                                                                                                                                           str(self.TSS_genomic_coord), str(self.TTS_genomic_coord))
